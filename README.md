...
Gemini API Integration: Leverages the Gemini API for advanced capabilities, specifically:

Object Detection: Identifies and locates different inventory items in the camera view.

Counting: Accurately counts the detected objects.

Tracking: Monitors the movement and location of items.
